package com.vgtech.common.view.photodraweeview;
...
public class PhotoDraweeView extends SimpleDraweeView implements IAttacher {
    ...
    @Override
    public void setOnViewTapListener(Attacher.OnViewTapListener listener) {
        mAttacher.setOnViewTapListener(listener);
    }

    @Override
    public void setOnPhotoTapListener(Attacher.OnPhotoTapListener listener) {
    ...
    public void setPhotoUri(String thumbUri,Uri uri) {
