...
/**
 * Created by zhangshaofang on 2015/11/21.
 */
public class FileCacheUtils {
    ...
    public static File getXmppImageDir(Context context) {
        File cacheDir = StorageUtils.getOwnCacheDirectory(context, context.getPackageName() + "/cache/chat/image");
        return cacheDir;
    }
    ...
    public static File getXmppAudioDir(Context context) {
        File cacheDir = StorageUtils.getOwnCacheDirectory(context, context.getPackageName() + "/cache/chat/audio");
        return cacheDir;
    }
