...
public class ActionSheetDialog {
    ...
    public enum SheetItemColor {
        Blue("#037BFF"), Red("#FD4A2E"),PeStyle("#faa41d");
    ...
    public <T> void showActionSheetDialog(final List<T> list, String showFiledName,
        ...
        try {
            ...
            for (T t : list) {
                ...
                this.addSheetItem(showName, ActionSheetDialog.SheetItemColor.Blue,
                        new OnSheetItemClickListener() {
                            @Override
                            public void onClick(int which) {
                                listener.onClick(list.get(which));
                            }
                        });
            }
        }
            ...
            e.printStackTrace();
            this.addSheetItem("showFiledName传错了", ActionSheetDialog.SheetItemColor.Blue,
                    new OnSheetItemClickListener() {
                        @Override
                        public void onClick(int which) {
