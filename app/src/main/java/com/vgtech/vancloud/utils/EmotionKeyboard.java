...
public class EmotionKeyboard {
    ...
    private ShowAndHidListener listener;
    ...
    public EmotionKeyboard setShowAndHidListener(ShowAndHidListener listener) {
    ...
    private void showEmotionLayout() {
        ...
        if (softInputHeight != 0)
            ...
            mEmotionLayout.getLayoutParams().height = Utils.convertDipOrPx(mActivity, 250);
        }
//        else
//            mEmotionLayout.getLayoutParams().height = LinearLayout.LayoutParams.WRAP_CONTENT;
