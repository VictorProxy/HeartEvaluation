package com.vgtech.vancloud.utils.videoplayer;
...
public class VideoPlayer extends RelativeLayout {
    ...
    public void onCreate() {
        ...
        videoDownload = (ImageView) findViewById(R.id.videoDownload);
        videoFavorite = (ImageView) findViewById(R.id.videoFavorite);
        videoPower = (ImageView) findViewById(R.id.videoPower);

        videoPlay = (ImageView) findViewById(R.id.videoPlay);
        videoPlayProgress = (SeekBar) findViewById(R.id.videoPlayProgress);
        videoTimeProgress = (TextView) findViewById(R.id.videoTimeProgress);
        videoFullScreen = (ImageView) findViewById(R.id.videoFullScreen);
        videoLoading = (ProgressBar) findViewById(R.id.videoLoading);
    ...
    public void goToFullScreen() {
        if (!fullScreen) {
            ...
            if (getLayoutParams() == null) {
                setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, screenWidth));
            } else {
    ...
    public void backFromFullScreen() {
        if (fullScreen) {
            ...
            if (getLayoutParams() == null) {
                setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT, screenWidth * 9 / 16));
            } else {
    ...
    private void play() {
        ...
        switch (state) {
            case 0:
                ...
                filePath = fh.SDPATH + fh.Path + "111.mp4";//getStoreName("v", ".mp4");
     ...
     * TODO 下载和缓冲mp4文件头部数据
     */
    private void prepareDownloadVideo() throws IOException {
