...
public class Session {
	...
	public void initialize(Activity activity){
        ...
        if(StringHandler.isEmpty(tm.getDeviceId())){
        	...
        	map.put(DEVICE_ID, MD5.md5(tm.getDeviceId())); // DEVICE_ID
        }
        map.put(MODEL, Build.MODEL);	// 手机机型
        map.put(SYSTEM_VERSION_NAME, Build.VERSION.RELEASE);	// 操作系统版本名称，如：4.4
        map.put(SYSTEM_VERSION_CODE, Build.VERSION.SDK_INT);	// 操作系统版本号，如：21
		try {
