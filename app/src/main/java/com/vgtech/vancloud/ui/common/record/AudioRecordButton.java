...
public class AudioRecordButton extends Button implements AudioManager.AudioStageListener {
	...
	public AudioRecordButton(Context context, AttributeSet attrs) {
		...
		// 这里没有判断储存卡是否存在，有空要判断
		mAudioManager = AudioManager.getInstance(context.getExternalFilesDir(null).toString());
//		mAudioManager = AudioManager.getInstance(Utils.getTempDirectoryPath(context));
