...
/**
 * Numeric wheel com.vgtech.personaledition.view.
 * 
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF05d5d5d;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF5d5d5d;
...
//			itemsPaint.setTypeface(Typeface.SANS_SERIF);
		}

		if (valuePaint == null) {
			valuePaint = new TextPaint(Paint.FAKE_BOLD_TEXT_FLAG
					| Paint.DITHER_FLAG);
