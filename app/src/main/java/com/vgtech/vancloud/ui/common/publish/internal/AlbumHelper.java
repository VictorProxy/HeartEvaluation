...
public class AlbumHelper {
     ...
     * 是否创建了图片集
     */
    public static boolean hasBuildImagesBucketList = false;
    ...
    public List<ImageBucket> getImagesBucketList(boolean refresh) {
        ...
        Iterator<Entry<String, ImageBucket>> itr = bucketList.entrySet().iterator();
        ImageBucket cameraImageBucket = null;
        //将Hash转化为List
        while (itr.hasNext()) {
            Entry<String, ImageBucket> entry = (Entry<String, ImageBucket>) itr.next();
            ...
            if (!imageBucket.bucketName.equalsIgnoreCase("Camera")) {
                ...
                cameraImageBucket = imageBucket;
            }
        }
        if (cameraImageBucket != null) {
            tmpList.add(0, cameraImageBucket);
        }
