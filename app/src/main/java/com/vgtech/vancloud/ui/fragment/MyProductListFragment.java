 ...
 */
public class MyProductListFragment extends BaseFragment implements HttpListener<String>, PullToRefreshBase.OnRefreshListener2, AdapterView.OnItemClickListener {
    @Override
    ...
    private void loadData(int nextId) {
        ...
        params.put("categoryID", showType);
