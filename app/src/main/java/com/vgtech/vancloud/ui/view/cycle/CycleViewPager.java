 ...
 * 实现可循环，可轮播的viewpager
 */
public class CycleViewPager  implements OnPageChangeListener {
    ...
    private View mBanderView;
    public  CycleViewPager(View view,FragmentActivity activity) {
        mActivity = activity;
 ...
 mBanderView = view.findViewById(R.id.layout_viewager_content);
        viewPagerFragmentLayout = (FrameLayout) view
                .findViewById(R.id.layout_viewager_content);

        handler = new CycleViewPagerHandler(mActivity) {
