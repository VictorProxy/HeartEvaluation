 ...
 */
public class MyScaleListFragment extends BaseFragment implements HttpListener<String>, PullToRefreshBase.OnRefreshListener2, AdapterView.OnItemClickListener {
    @Override
    ...
    private void loadData(int nextId) {
        ...
        NetworkPath path = new NetworkPath(URLAddr.URL_SCALE_MYSCALE, params, getActivity());
