 ...
 */
public class AppointMentListFragment extends BaseFragment implements HttpListener<String>, PullToRefreshBase.OnRefreshListener2, AdapterView.OnItemClickListener {
    @Override
    protected int initLayoutId() {
        return R.layout.fragment_scalelist;
    }

    private ReservationAdapter scaleAdapter;
    ...
    protected void initView(View view) {
        ...
        scaleAdapter = new ReservationAdapter(getActivity());
    ...
    private void loadData(int nextId) {
        ...
        NetworkPath path = new NetworkPath(URLAddr.URL_RESERVATION_COUNRESERVATIONLIST, params, getActivity());
    ...
    public void dataLoaded(int callbackId, NetworkPath path, RootData rootData) {
        ...
        try {
            ...
            List<Reservation> scales = JsonDataFactory.getDataArray(Reservation.class, jsonObject.getJSONArray("reservationList"));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (obj instanceof Reservation) {
            ...
            Fragment fragment = new ReservationItemActivity();
